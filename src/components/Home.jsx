  ...
  return (
    <div className="mycontainer mt-4 mb-5">
      ...
      <div className="row mt-5 h-100 hero">
        <div className="col-lg-4 jazzy-img d-none d-md-none d-lg-block h-100">
          <img
              ...
              return (
                ...
                >
                  ...
                  <div className="card-body p-2 burger-body">
                    <p className="burger-title mb-3 fw-bold">{title}</p>
                    <p className="burger-total mb-3">Total Price</p>
                    <p className="burger-price mb-5">
                      <img className="img-fluid" src={naira} alt="" />
                      <span>{price}.0</span>
                    </p>
                    <img
                      className="img-fluid mb-4 food-group"
                      src={foodgroup}
                      alt=""
                    />
                    <button className="cart-btn d-flex justify-content-center align-items-center mb-1">
                      <img className="plus-icon" src={addIcon} alt="" />
